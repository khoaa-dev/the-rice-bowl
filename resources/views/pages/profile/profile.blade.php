...
<style>
    ...
    .sidebar__item-link:hover .sidebar__item {
                        ...
                        <div class="account-s ettings">
                            <div class="user-profile text-center">
                                ...
                                <div class="sidebar mt-5">
                                    <div class="sidebar__item" style="background-color: #303344;border-radius: 5px">
                                        <a class="sidebar__item-link" href="{{ route('profile') }}">Thông tin cá nhân</a>
                                    </div>
    
                                    <div class="sidebar__item"
                                        style="background-color: #2f3142; margin-top: 20px;border-radius: 5px">
                                        <a class="sidebar__item-link" href="{{ route('history') }}">Lịch sử đặt hàng</a>
                                    </div>
                                </div>
