...
@section('profile-body')
    <div class="row gutters">
        <div class="col-12">
            <h6 class="mb-3 text-primary" style="font-size: 20px; font-weight: bold;">Lịch sử đặt hàng</h6>
        </div>
        <div class="col-12">
                ...
                <tbody class="text-center" style="font-size: 18px; color: #ccc">
                    @foreach ($orders as $order)
                        <tr class="even pointer" style="height: 70px">
                            ...
                            <td class=" last">
                                <button class="btn btn-info" style="border-radius: 5px; font-size: 16px"
                                    onclick="window.location.href = '{{ URL::to('/orders/' . $order->id) }}' ">Xem chi
                                    tiết</button>
                            </td>
                        </tr>
                    @endforeach
