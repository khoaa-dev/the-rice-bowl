    ...
    <div class="right_col" role="main" style="min-height: 1000px">
        <div class="col-12">
            ...
            <ul class="nav nav-tabs nav-tab tabs d-flex text-center col-12" style="background: #eaeaea">
                <li class="tab-item active col-6"><a data-toggle="tab" href="#tab-9-3" data-case="HDLocal">Đơn hàng chờ
                        duyệt</a></li>
                <li class="tab-item col-6"><a data-toggle="tab" href="#tab-9-1" data-case="HDPassenger">Đơn hàng đã
                        duyệt</a></li>
                <div class="line"></div>
            </ul>
        </div>
        ...
        <div class="col-12">
            <div class="tab-pane active">
                <div class="row">
                    <div class="x_panel">
                        <div class="status">
                            @if (session('status'))
                                <h6 style="font-size:16px !important" class="alert alert-success">{{ session('status') }}
                                </h6>
                            @endif
                        </div>
                        <div class="p-2">
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td class=" last">
                                                    <a class="btn btn-warning"
                                                        href="{{ URL::to('/admin/orders/' . $pendingOrder->id) }}">Xem</a>
                                                    <form
                                                        action="{{ URL::to('/admin/orders/' . $pendingOrder->id . '/confirm') }}"
                                                        method="POST" id="confirmOrderForm" style="display: none">
                                                        @csrf
                                                    </form>
                                                    <a class="btn btn-warning"
                                                        onclick="document.getElementById('confirmOrderForm').submit()">Duyệt</a>
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="tab-pane">
                <div class="row">
                                    ...
                                    <tbody class="text-center" style="font-size: 16px">
                                        ...
                                        @foreach ($approvedOrders as $approvedOrder)
                                            <tr class="even pointer">
                                                ...
                                                <td class="align-items-center ">{{ $approvedOrder->order_status->name }}
                                                </td>
                                                <td class=" last">
                                                    {{-- <button type="button" class="btn btn-warning" data-toggle="modal"
                                                data-target="#modalViewDetailOrder">Xem chi tiết</button> --}}
                                                    <button type="button" class="btn btn-warning" id="btn-view-order">Xem
                                                        chi
                                                        tiết</button>
                                                </td>
                                            </tr>
                    ...
                    <div class="modal fade" id="modalViewDetailOrder" tabindex="-1" role="dialog"
