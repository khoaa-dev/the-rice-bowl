        ...
        <div class="card-body" style="font-size: 20px">
          <form action="{{ URL::to('/admin/orders/'.$order->id.'/confirm') }}" method="POST"
            ...
            <div class="form-group">
              ...
              <input type="number" name="price" id="price" class="form-control" value="{{$order->peopleNumber}}"
                disabled>
            </div>

            <div class="form-group">
              <label for="image">Ngày tổ chức:</label>
              <input type="text" name="image" id="image" class="form-control" value="{{$order->organizationDate}}"
                disabled>
            </div>
            <div class="form-group">
