                ...
                <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="text">
                            ...
                            <div class="meta">
                                <div><a href="#" style="font-family: 'Josefin Sans';"><span
                                            class="icon-calendar"></span> 12 tháng 1, 2021</a></div>
                                <div><a href="#" style="font-family: 'Josefin Sans';"><span
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            ...
                            <div class="meta">
                                <div><a href="#" style="font-family: 'Josefin Sans';"><span
                                            class="icon-calendar"></span> 22 tháng 12, 2021</a></div>
                                <div><a href="#" style="font-family: 'Josefin Sans';"><span
                                            class="icon-person"></span> Admin</a></div>
                                <div><a href="#" style="font-family: 'Josefin Sans';"><span
                                            class="icon-chat"></span> 23</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-2 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#" class="py-2 d-block"
                                style="font-family: 'Josefin Sans'; font-size: 18px">Sinh nhật</a></li>
                        <li><a href="#" class="py-2 d-block"
                                style="font-family: 'Josefin Sans'; font-size: 18px">Thôi nôi</a></li>
                        <li><a href="#" class="py-2 d-block"
                                style="font-family: 'Josefin Sans'; font-size: 18px">Tiệc theo chủ đề</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text"
                                    style="font-family: 'Josefin Sans'; font-size: 18px">123 Nguyễn Văn Linh,
                                    phường Thanh Bình, quận Hải Châu, thành phố Đà Nẵng</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text"
                                        style="font-family: 'Josefin Sans'; font-size: 18px">+84 987 789
                                        999</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text"
                                        style="font-family: 'Josefin Sans'; font-size: 18px">thericebowl@gmail.com</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
