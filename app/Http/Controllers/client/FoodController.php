...
class FoodController extends Controller
{
    public function getSearchAjax(Request $request)
    {
        ...
        foreach ($foods as $food) {
            ...
            $output .=  '&nbsp;&nbsp;';
            $output .= '<h3 style="padding-top: 7px;">
                             <span style="color: rgb(238, 222, 200) !important; background: none;">' . $food->name . '</span> </h3>';

            $output .= '<span class=" price" style="color: rgb(238, 222, 200); font-size: 18px !important; background: none">';
    ...
    public function updateMenu(Request $request)
    {
        ...
        foreach ($foods as $food) {
            $output .= '<div>'
                ...
                . '&nbsp;&nbsp;'
                . '<h3 style="background: none; font-size: 20px"><span>' . $food->name . '</h3>'
                . '<span class="price" style="color: #563c05; font-size: 20px">' . number_format($food->price, 0) . ' đ' . '</span>'
                . '</div></div>';
        }
        ...
        $output .= '<div class="align-items-center add-food">
                    ...
                    <div class="d-flex text align-items-center">
                        ...
                        <span class="price total" style="width: 200px; color: #563c05;">' . number_format($totalPrice, 0) . ' đ</span>
                    </div>';
